...
enum CategoryIcon {
  ...
  phone('phone', Icons.phone_iphone_rounded, '手机', CategoryIconGroup.daily),
  watch('watch', Icons.watch_rounded, '手表', CategoryIconGroup.daily),
  keyboard('keyboard', Icons.keyboard_rounded, '键盘', CategoryIconGroup.daily),
  mouse('mouse', Icons.mouse_rounded, '鼠标', CategoryIconGroup.daily),
  lightbulb(
    'lightbulb',
  ...
  tools('tools', Icons.build_rounded, '工具', CategoryIconGroup.daily),
  key('key', Icons.key_rounded, '钥匙', CategoryIconGroup.daily),
  backpack('backpack', Icons.backpack_rounded, '背包', CategoryIconGroup.daily),
  flashlight(
    'flashlight',
  ...
  wifi('wifi', Icons.wifi_rounded, '上网', CategoryIconGroup.daily),
  heart('heart', Icons.favorite_rounded, '爱心', CategoryIconGroup.daily),
  health(
    'health',
  ...
  hotel('hotel', Icons.hotel_rounded, '酒店', CategoryIconGroup.leisure),
  map('map', Icons.map_rounded, '地图', CategoryIconGroup.leisure),
  explore(
    'explore',
  ...
  public('public', Icons.public_rounded, '地球', CategoryIconGroup.leisure),
  terrain(
    'terrain',
  ...
  bar('bar', Icons.local_bar_rounded, '酒吧', CategoryIconGroup.leisure),
  ramen(
    'ramen',
